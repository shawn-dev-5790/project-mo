import { Product, ProductLanguage, ProductOptions, ProductsRes } from './product.dto'
...
export class ProductFactory {
  ...
  public generateProductRes(options: ProductOptions): ProductsRes {
    ...
    const lang_pack: Record<typeof options.lang_type, ProductLanguage> = {
      ko: {
        name: '이름',
        desc: '설명',
        price: '가격',
    ...
    const lang: ProductLanguage = lang_pack[options.lang_type] || lang_pack['ko']
